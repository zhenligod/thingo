...
import (
	...
	"github.com/zhenligod/thingo/chanlock"
)
...
func TestRedis(t *testing.T) {
	...
	str, err := cluster.Set("username", "zhenligod", 1000*time.Second).Result()
	log.Println(str, err)

	str, err = cluster.Set("myname", "zhenligod2", 1000*time.Second).Result()
	log.Println(str, err)

	log.Println(cluster.Get("username").Result()) // 2019/09/26 21:42:18 zhenligod <nil>
}
...
2019/11/06 22:11:08 OK <nil>
2019/11/06 22:11:08 zhenligod <nil>
--- PASS: TestRedis (0.03s)
PASS
ok  	github.com/zhenligod/thingo/goredis	0.028s
*/
